<div class="flex flex-row items-center justify-between py-4 text-background-600 dark:text-background-400">
    <hr class="w-full mr-2">
    {{ __('Or') }}
    <hr class="w-full ml-2">
</div>

<div class="flex items-center justify-center socialstream">
